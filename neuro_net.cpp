...
std::vector < std::vector <std::pair <size_t, double> > > NeuroNet::abs_mutation(double mut) {
    auto G = g;
    for (auto & x: G) {
        for (auto & y: x) {
...
std::vector < std::vector <std::pair <size_t, double> > > NeuroNet::rel_mutation(double mut) {
    auto G = g;
    for (auto & x: G) {
        for (auto & y: x) {
