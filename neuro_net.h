...
public:
    ...
    std::vector < std::vector <std::pair <size_t, double> > > g;//graph
    ...
    void getAns();
    void clear_values();
    std::vector < std::vector <std::pair <size_t, double> > > abs_mutation(double mut);
    std::vector < std::vector <std::pair <size_t, double> > > rel_mutation(double mut);
};
